...
export default function GoogleButton({ label = "Continue with Google" }: { label?: string }) {
  const handleGoogleSignIn = () => {
    // The backend handles the entire OAuth flow and redirects.
    // The client just needs to navigate to the starting endpoint.
  ...
  return (
    ...
    >
      <svg className="mr-2 h-4 w-4" aria-hidden="true" width="18" height="18" viewBox="0 0 48 48">
