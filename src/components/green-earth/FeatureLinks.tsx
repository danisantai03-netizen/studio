    ...
    <section aria-labelledby="features-heading">
      ...
      <div className="grid grid-cols-4 gap-3 px-4">
        {features.map((feature) => (
          ...
          >
            <div className="flex items-center justify-center w-16 h-16 transition-all duration-200 ease-in-out group-hover:scale-105 rounded-2xl bg-white shadow-sm p-2">
