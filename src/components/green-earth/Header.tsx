    ...
    <header className="px-6 pt-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="relative">
          <Button variant="secondary" size="icon" className="rounded-full w-12 h-12 bg-white shadow-sm active:opacity-70 focus:ring-0">
        ...
        <CardContent>
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-2">
              <Button variant="outline" className="rounded-full active:opacity-70 focus:ring-0 shadow-sm">
                <History className="mr-2 h-4 w-4" />
                View History
              </Button>
              <Button variant="default" className="bg-accent hover:bg-accent/90 text-accent-foreground active:opacity-70 focus:ring-0 rounded-full shadow-md">
